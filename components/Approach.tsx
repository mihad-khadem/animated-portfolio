"use client"; // Make sure this is at the top of the file to ensure it’s treated as a client component

import React, { useState } from "react"; // Import useState hook here
import { AnimatePresence, motion } from "framer-motion";
import { CanvasRevealEffect } from "./ui/CanvasRevealEffect"; // Make sure this path is correct
...
const Card = ({
  ...
  const [hovered, setHovered] = useState(false); // Now it's working in a client component
